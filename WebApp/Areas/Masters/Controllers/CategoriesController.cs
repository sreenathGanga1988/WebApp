...
namespace WebApp.Areas.Masters.Controllers
{
    public class CategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CategoryName,Color")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CategoryName,Color")] Category category)
        {
            if (ModelState.IsValid)
            {
